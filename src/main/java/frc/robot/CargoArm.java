...
public class CargoArm
{
    ...
    public Boolean isSafeToMove(double encCount, double amt)
    {
        ...
        //System.out.println("Safe to move? " + isSafe);
        return isSafe;
    }
    ...
    public void rotateArm(double amt)
    {
        ...
        if(amt != 0)
        {
            System.out.println("Moving arm manually!");
            moveToPosition = false;
        }
        ...
        if(moveToPosition)
        {
            ...
            {
                if(isSafeToMove(encCargoArm.position(), 1))
                {
                    moTalBallArm.set(ControlMode.PercentOutput, 1);
                }
                else
                {
                    moTalBallArm.set(ControlMode.PercentOutput, 0);
